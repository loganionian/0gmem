...
class MultiQueryGenerator:
    ...
    def generate_queries(self, question: str, target_entity: Optional[str] = None) -> List[str]:
        """
    ...
    def _generate_multihop_queries(self, question: str, entity: Optional[str]) -> List[str]:
    ...
    def _generate_temporal_queries(self, question: str, entity: Optional[str]) -> List[str]:
    ...
    def _generate_preference_queries(self, question: str, entity: Optional[str]) -> List[str]:
    ...
    def _generate_activity_queries(self, question: str, entity: Optional[str]) -> List[str]:
...
class MultiQueryRetriever:
    ...
    def retrieve(
        ...
        return [
            (doc_id, score, all_results[doc_id])
